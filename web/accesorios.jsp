...
<html>
    ...
    <body>
        ...
        <%
            ...
            productos = productoDao.listarAccesorios();
            ...
            <c:forEach var="prod" items="${productos}">
                <div class="tarjeta-producto">
                    <div class="tarjeta-imagen">
                        <img class="img" src="SrvProductoIMG?id=${prod.getId_producto()}" alt="Productos tienda"/>
                    </div>
                    <div class="tarjeta-titulo">
                        <h4>${prod.getNombre()}</h4>
                    </div>
                    <div class="tarjeta-precio">
                        <p>Precio: <b>Q${prod.getPrecio()}</b></p>
                    </div>
                    <div class="tarjeta-acciones">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td style="display: none">${prod.getId_producto()}</td>
                                    <td style="display: none">${prod.getNombre()}</td>
                                    <td style="display: none">${prod.getDetalle()}</td>
                                    <td style="display: none">${prod.getMarca()}</td>
                                    <td style="display: none">${prod.getTalla()}</td>
                                    <td style="display: none">${prod.getColor()}</td>
                                    <td style="display: none">${prod.getPrecio()}</td>
                                    <td style="display: none">${prod.getImagen()}</td>
                                    <td style="display: none">${prod.getEstado()}</td>                                    
                                    <td><a href="SrvProducto?action=agregarCarrito&id=${prod.getId_producto()}&id_cat=${prod.getId_categoria()}" title="Añadir al carrito"><i class="fa-sharp fa-solid fa-cart-plus"></i></a></td>

                                    <td><a type="submit" class="btn-ver" >Detalle</a></td>
                                </tr>                     
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="modal fade" id="modalProducto" data-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header d-flex flex-row" style="background-color: var(--color-fondo);">
                        <h4><b>Detalle de producto</b></h4>
                        <button style="width: 50px; padding: 0" type="button" class="close btn" data-bs-dismiss="modal" aria-label="Close" >
                            <span aria-hidden="true" style=" color: var(--color-secundario); outline: none;"><b>X</b></span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="contenedor-detalle-img">
                            <img class="img-detalle" src="" id="imagen" alt="artículo de vestir"> 
                        </div>
                        <div class="contenedor-detalle">                            
                            <!-- <ul>
                                 <li><b>Producto: </b><input type="text" id="txt_nombre" disabled></li>
                                 <li><b>Detalle: </b><input type="text" id="txt_detalle" disabled></li>
                                 <li><b>Marca: </b><input type="text" id="txt_marca" disabled></li>
                                 <li><b>Talla: </b><input type="text" id="txt_talla" disabled></li>
                                 <li><b>Color: </b><input type="text" id="txt_color" disabled></li>
                                 <li><b>Precio: </b>Q<input type="text" id="txt_precio" disabled></li>
                             </ul>-->

                            <div class="contenedor-detalle-descrip">
                                <ul type="none">
                                    <li><b>Producto: </b></li>
                                    <li><b>Detalle: </b></li>
                                    <li><b>Marca: </b></li>
                            ...
                            <div class="contenedor-detalle-contenido">
                                <ul type="none">
                                    <li><input type="text" id="txt_nombre" disabled></li>
                                    <li><input type="text" id="txt_detalle" disabled></li>
                                    <li><input type="text" id="txt_marca" disabled></li>
                                    <li><input type="text" id="txt_talla" disabled></li>
                                    <li><input type="text" id="txt_color" disabled></li>
                                    <li>Q<input type="text" id="txt_precio" disabled></li>
                                </ul>                                
                            </div>
