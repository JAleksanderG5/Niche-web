                ...
                <div class="col-sm-4 carrito-card">
                    <div class="cards">
                        ...
                        <div class="cards-footer">
                            ...
                            %>
                            <a href="login.jsp" class="">Iniciar Sesión</a>
                            <!-- <a href="controlador?accion=GenerarCompra" class="">Iniciar Sesión</a> -->
                            <%}%>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" style="background-color: var(--color-fondo);">
                        <div class="modal-header modal-cabecera">
                            <h5  id="staticBackdropLabel"><b>Confirmación de compra </b><i style="font-size: 1.5rem; color: var(--color-secundario)" class="fa-solid fa-face-laugh-wink"></i></h5>                          
                        ...
                        <div class="modal-body">
                            <form action="SrvProducto" method="post">
                                ...
                                <label><b>Elegir método de pago</b></label>                        
