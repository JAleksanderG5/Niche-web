...
<html>
    ...
    <body>
        ...
        <section class="contenido">
            <section id="inicio">                
                <article class="hero-image" style="--hero-image: url('../assets/hero-image-home.jpeg'); --hero-attachment: fixed; ">
                    <aside class="hero-image-opacity" style="--hero-opacity-color: var(--black-alpha-color)">
                        <div class="hero-image-content">
                            <h2 class="hero-image-title">Niche
                            </h2>
                            <a href="#contacto" class="btn"><b>CONTÁCTANOS</b></a>
                        </div>
                    </aside>
                </article>
            </section>
            <section id="acerca" class="acerca">
                <div class="container-general section-acerca">
                    <article class="acerca-title-group">
                        <h2 class="acerca-title">Acerca</h2>
                        <p>Somos una tienda de ropa pre-loved con alta variedad de prendas para damas, caballeros y niños a precios accesibles y al alcance de tu bolsillo, fuimos desarrollados por una organización sin fines de lucro para apoyar a una entidad la cual su función primordial es el servicio social en su comunidad.</p>
                    </article>
                    <article class="acerca-contain">
                        <div class="imagen">
                            <img src="assets/niche1.jpeg" alt="Tienda de ropa niche"/>
                        </div>
                        <div class="acerca-texto">
                            <h2>Visión</h2>
                            <p>Ser una tienda líder a nivel departamental superando las expectativas de nuestros consumidores con prendas de diseño único, ofreciendo un servicio excelente y confiable.</p>
                        </div>
                        <div class="acerca-texto">
                            <h2>Misión</h2>
                            <p>Ofrecer a nuestros clientes productos de calidad a precios cómodos que cumplan con sus necesidades y exigencias, abarcando sus gustos de acuerdo con su estilo de ver y vivir la vida.</p>
                        </div>
                        <div class="imagen">
                            <img src="assets/niche2.jpeg" alt="Tienda de ropa niche"/>
                        </div>                        
                    </article>
                </div>  
            </section>
            <section id="contacto" class="contacto">
                <div class="container-general contacto-container">
                    <article class="contacto-title-group">
                        <h2 class="acerca-title">Contacto</h2>                        
                    </article>
                    <section class="contacto-contenido">
                        <div class="tarjetas">
                            ...
                            <h3>UBICACION</h3>
                            <p>4ta. calle oriente #10, Casa Antigua "El Jaulon", Antigua Guatemala</p>
                        </div>
                        <div class="tarjetas">
                            ...
                            <h3>FACEBOOK</h3>
                            <a href="https://www.facebook.com/NicheAntigua" target="_blank">Ir a</a>
                        </div>
                        <div class="tarjetas">
                            ...
                            <h3>INSTAGRAM</h3>
                            <a href="https://www.instagram.com/niche.antigua/" target="_blank">Ir a</a>
                        </div>
                    </section>
                </div>
            </section>
