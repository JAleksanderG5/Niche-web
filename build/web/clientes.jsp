...
<html lang="es">
    ...
    <body style="font-family:'Nunito Sans', sans-serif" onLoad="limpiarform">
        <%
        ...
        <section class="contenido-carrito">
            <div class="contenedor-cliente">
                <div class="contenedor-cliente-cab">                    
                    <h2>Hola.. <b>${cliente.getNombres()}</b></h2>
                    <input type="hidden" id="txt_idCliente" name="txt_idCliente" value="${cliente.getId_cliente()}">
                    <input type="hidden" id="txt_evaluarCorreo" name="txt_evaluarCorreo" value="${cliente.getCorreo()}">
                    <a href="SrvAcceso?accion=cerrarCliente">Cerrar Sesión</a>
                </div>

                <section class="tarjetas-cliente-contenido">
                    <div class="tarjetas tarjetas-cliente">
                        <i class="fa-solid fa-user-tag"></i>
                        <h4><b>Datos Personales</b></h4>
                        <a href="datosCliente.jsp">Ir a</a>
                    </div>
                    <div class="tarjetas tarjetas-cliente">
                        <i class="fa-solid fa-truck-fast"></i> 
                        <h4><b>Datos Envio</b></h4>
                        <a href="SrvCliente?action=listarDatosEnvio&id_c=${cliente.getId_cliente()}">Ir a</a>
                    </div>
                    <div class="tarjetas tarjetas-cliente">
                        <!--<i class="fa-sharp fa-solid fa-basket-shopping"></i>-->
                        <svg width="55" height="55" viewBox="0 0 36 36" fill="" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.53797 31.8417H7.07594V14.1519C7.07594 13.1736 7.86667 12.3829 8.84492 12.3829H30.0727V8.84492C30.0727 7.86667 29.282 7.07594 28.3038 7.07594H22.9066C22.4608 3.10634 19.1227 0 15.0364 0C10.95 0 7.61194 3.10634 7.16616 7.07594H1.76898C0.790736 7.07594 0 7.86667 0 8.84492V28.3038C0 30.2567 1.58501 31.8417 3.53797 31.8417ZM15.0364 3.53797C17.1715 3.53797 18.96 5.0593 19.3704 7.07594H10.7024C11.1128 5.0593 12.9012 3.53797 15.0364 3.53797Z" fill=""/>
                        <path d="M33.6108 15.9209H12.3829C11.4047 15.9209 10.614 16.7116 10.614 17.6898V31.8417C10.614 33.7947 12.199 35.3797 14.1519 35.3797H31.8418C33.7947 35.3797 35.3797 33.7947 35.3797 31.8417V17.6898C35.3797 16.7116 34.589 15.9209 33.6108 15.9209ZM22.9968 28.3037C18.1198 28.3037 14.1519 24.3359 14.1519 19.4588H17.6899C17.6899 22.3847 20.0709 24.7658 22.9968 24.7658C25.9227 24.7658 28.3038 22.3847 28.3038 19.4588H31.8418C31.8418 24.3359 27.8739 28.3037 22.9968 28.3037Z" fill=""/>
                        </svg>
                        <h4><b>Compras</b></h4>
                        <!--<a href="SrvPedidos?action=listarPedidos&id_p=${cliente.getId_cliente()}">Ir a</a> -->
                        <a href="SrvProducto?action=listarPedidos&id_p=${cliente.getId_cliente()}">Ir a</a>
                    </div>
                </section>
        ...
        $('#tbl_cliente').on('click', 'tr td', function (evt) {
            var target, id_cliente, nombres, apellidos, correo, password, telefono, id_usuario;
            target = $(event.target);
            ...
            id_usuario = target.parent("tr").find("td").eq(6).html();
