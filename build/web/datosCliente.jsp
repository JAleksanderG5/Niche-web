        ...
        <section class="contenido-carrito">
            <div class="contenedor-form-cliente">
                ...
                <section class="form-cliente-contenido box-shadow-1">
                    <form action="SrvAcceso" method="post" id="form-cliente" class="form-group form-cliente" style="text-align: left;">                                                                                 
                        ...
                        <input type="email" name="txt_correo" id="txt_correo" class="form-control" title="Email incorrecto"
                               pattern="^[a-z0-9]+(\.[_a-z0-9]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,15})$" required readonly>
                        ...
                        <input type="hidden" name="txt_usuario" id="txt_usuario" class="form-control" value="0" readonly required> 
                        <br>
                        <button id="btn_modificar" type="submit" name="accion" class="btn-opcion-modal" value="modificarCliente" style="display:inline-block;">Modificar</button>                                                                
                        <a href="clientes.jsp" style="display:inline-block;">Regresar</a>                                                                
                    </form>                        
                </section>

                <div>
                    <input type="hidden" id="id" value="${cliente.getId_cliente()}">
                    <input type="hidden" id="nombres" value="${cliente.getNombres()}">
                    <input type="hidden" id="apellidos" value="${cliente.getApellidos()}">
                    <input type="hidden" id="correo" value="${cliente.getCorreo()}">
                    <input type="hidden" id="pass" value="${cliente.getPassword()}">
                    <input type="hidden" id="telefono" value="${cliente.getTelefono()}">
                    <input type="hidden" id="usuario" value="${cliente.getId_usuario()}">
                </div>
