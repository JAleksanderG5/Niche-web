    ...
    <body>
        ...
        <section class="form box-shadow-1">
            <div class="form-group">
                ...
                <br>
                <form action="SrvAcceso" method="post" autocomplete="off">
                    ...
                    <div class="input-group">
                        ...
                        <span id="imgContrasena" data-activo=false><img src="https://cdn3.iconfinder.com/data/icons/show-and-hide-password/100/show_hide_password-10-256.png" class="icon"></span>
                    </div>

                    <span>${error}</span>

                    <button class="btn" name="accion" value="ingresar">Ingresar</button>
                    <a class="btn btn-2" href="registro.jsp">Registrarme</a>
                </form>
            </div>
        </section>
